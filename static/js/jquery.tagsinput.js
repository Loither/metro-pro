...
(function ($) {
    ...
    $.fn.addTag = function (value, options) {
        ...
        this.each(function () {
            ...
            if (value != '' && skipTag != true) {
                ...
                // Call custom update count function!
                $.fn.updateCount(tagslist);
    ...
    $.fn.updateCount = function (tagslist) {
        //Show number of results available, bit of a hack
        var staff = false;
        var alumni = false;
    ...
    $.fn.tagsInput = function (options) {
        ...
        this.each(function () {
            ...
            $.each([].filter.call(this.attributes, function (at) {
            ...
            if (settings.interactive) {
                ...
                if (settings.autocomplete_url !== undefined || settings.autocomplete !== undefined) {
                    autocomplete_options = (settings.autocomplete_url !== undefined) ? {
                    ...
                    if (jQuery.Autocompleter !== undefined) {
                        ...
                        $(data.fake_input).bind('typeahead:selected', data, function (event, datum, name) {
                            ...
                            $(event.data.real_input).addTag(datum.value, {
                                focus: true,
                                unique: (settings.unique)
                            });
                            return false;
